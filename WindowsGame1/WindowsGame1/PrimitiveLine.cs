...
namespace WindowsGame1
{
    public class PrimitiveLine
    {
        ...
        {
            // create pixels
            pixel = new Texture2D(graphicsDevice, 1, 1, false, SurfaceFormat.Color); // Modified by Tanaka
//            pixel = new Texture2D(graphicsDevice, 1, 1, 1, TextureUsage.None, SurfaceFormat.Color); // original
        ...
        public void CreateLine(Vector2 line)
        {
            vectors.Clear();

            vectors.Add(new Vector2(0, 0));
            vectors.Add(new Vector2(line.X, line.Y));
        } 
        ...
        public void CreateEllipse(float semimajor_axis, float semiminor_axis, float angle_offset, int sides)
        {
            vectors.Clear();
        ...
        public void CreateBox(Vector2 topLeft, Vector2 botRight)
        {
            ...
            float Xdistance = -topLeft.X - -botRight.X;
            float Ydistance = botRight.Y - topLeft.Y;

            vectors.Add(new Vector2(0, 0));
            vectors.Add(new Vector2(Xdistance, 0));

            vectors.Add(new Vector2(Xdistance, Ydistance));
            vectors.Add(new Vector2(0, Ydistance));
